  ...
  await axios
    ...
    .catch((err) => {
      if (err.response && err.response.status === 422) {
        ...
        // General server error like DB exception
                ...
                <div class="space-y-2">
                  ...
                  <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    ...
                    <div class="sm:col-span-1">
                      <label
                        ...
                        class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400"
                      >
                        My Kad<span class="text-error-500">*</span>
                      </label>
                      <input
                        v-model="form.ic_no"
                        type="text"
                        ...
                        class="dark:bg-dark-900 h-8 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800"
                      />
                      <p v-if="errors.ic_no" class="mt-2 text-sm text-red-600">
                        {{ errors.ic_no[0] }}
                      </p>
                    </div>
                    <!-- Jawatan -->
                    <div class="sm:col-span-1">
                      <label
                        ...
                        class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400"
                      >
                        Jawatan<span class="text-error-500">*</span>
                      </label>
                      <input
                  ...
                  <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    ...
                    <div class="sm:col-span-1">
                      <label
                        ...
                        class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400"
                      >
                        No Telefon<span class="text-error-500">*</span>
                      </label>
                      <input
                  ...
                  <div>
                    ...
                    <input
                      ...
                      id="email"
                      name="email"
                      placeholder="Masukkkan alamat emel anda"
                      class="dark:bg-dark-900 h-8 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800"
                    />
                  ...
                  <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    ...
                    <div class="sm:col-span-1">
                      ...
                      <div class="relative">
                        <input
                          ...
                          class="dark:bg-dark-900 h-8 w-full rounded-lg border border-gray-300 bg-transparent py-2.5 pl-4 pr-11 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800"
                        />
                    ...
                    <div class="sm:col-span-1">
                      <label
                        ...
                        class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400"
                      >
                        Ulang Kata Laluan<span class="text-error-500">*</span>
                      </label>
                      <div class="relative">
                        <input
                    ...
                    <div>
                      ...
                      >
                        ...
                        <p class="inline-block font-normal text-gray-500 dark:text-gray-400">
                          Dengan mendaftar akaun, anda bersetuju dengan
                          <span class="text-gray-800 dark:text-white/90"> Terma dan Syarat </span>
                          serta
                          <span class="text-gray-800 dark:text-white"> Polisi Privasi kami. </span>
                        </p>
                      </label>
                    </div>
                  </div>
