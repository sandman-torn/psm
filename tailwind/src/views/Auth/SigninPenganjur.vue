              ...
              <div>
                  ...
                  <div class="space-y-5">
                    ...
                    <div class="flex items-center justify-between">
                      ...
                      <router-link to="/reset-password"
                        class="text-sm text-brand-500 hover:text-brand-600 dark:text-brand-400">Lupa kata
                        laluan?</router-link>
                    </div>
                    <!-- Button -->
                    <div>
                ...
                <div class="mt-5">
                  <p class="text-sm font-normal text-center text-gray-700 dark:text-gray-400 sm:text-start">
                    Tiada akaun Pengajur? Sila hubungi Pentadbir Sistem
                    <!-- <router-link to="/signup"
                      class="text-brand-500 hover:text-brand-600 dark:text-brand-400">Daftar</router-link> -->
                  </p>
                </div>
              </div>
            </div>
