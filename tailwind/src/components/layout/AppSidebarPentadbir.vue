<template>
  <aside :class="[
    ...
    <div :class="[
      ...
      <router-link to="/">
        <img v-if="isExpanded || isHovered || isMobileOpen" class="dark:hidden mx-auto" src="/images/logo/ePNJevent.png"
        ...
        <img v-else src="/images/logo/ePNJevent.png" alt="Logo" width="32" height="32" />
      </router-link>
    </div>
