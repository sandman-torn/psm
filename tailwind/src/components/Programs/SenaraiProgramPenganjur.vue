      ...
      <table class="min-w-full">
        <thead>
          <tr class="border-b border-gray-200 dark:border-gray-700">
            ...
            <th class="px-5 py-3 text-left w-2/11 sm:px-6">
              <p class="font-medium text-gray-500 text-theme-xs dark:text-gray-400">Pegawai Bertanggungjawab</p>
            </th>
            <th class="px-5 py-3 text-left w-2/11 sm:px-6">
        ...
        <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
          ...
          >
            ...
            <td class="px-5 py-4 sm:px-6">
              <p class="text-center text-gray-500 text-theme-sm dark:text-gray-400">{{ programs.created_by_name}}<br> [{{ programs.by_unit_name}}]</p>
            </td>
            <td class="px-5 py-4 sm:px-6">
              <div class="flex gap-2">
                <RouterLink :to="{ name: 'Borang Kemaskini Program.edit', params: { id: programs.id } }"
                ...
                <button
                  @click="confirmDelete(programs.id)"
...
const fetchPrograms = async () => {
  try {
    ...
    programs.value = response.data // if using resource
